...
export default function BottomBar() {
    ...
    useEffect(() => {
        if (typeof window != undefined && localStorage.getItem("profileObj")) {
            setProfile(JSON.parse(localStorage.getItem("profileObj")).picture);
        }
    })

    return <div className="sm:hidden fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
